...
public class Main {
	public static void main(String[] args) {
		...
		Player p4 = new Player("Jhon","Doe","cricket player",169);Player p1 = new Player("Akshay","patidaar","cricket player",22);
		Player p2 = new Player("Sachin","Tendulkar","cricket player",222);
		Player p3 = new Player("Aashish","Sehwag","cricket player",98);
		Player p4 = new Player("Jhon","Doe","cricket player",169);
		Player p5 = new Player("ALex","Albon","F1 Driver",32);Player p1 = new Player("Akshay","patidaar","cricket player",22);
		Player p2 = new Player("Sachin","Tendulkar","cricket player",222);
		Player p3 = new Player("Aashish","Sehwag","cricket player",98);
		Player p4 = new Player("Jhon","Doe","cricket player",169);
		Player p5 = new Player("ALex","Albon","F1 Driver",32);Player p1 = new Player("Akshay","patidaar","cricket player",22);
		...
		Player p3 = new Player("Aashish","Sehwag","cricket player",98);
		Player p4 = new Player("Jhon","Doe","cricket player",169);
		Player p5 = new Player("ALex","Albon","F1 Driver",32);v
		Player p5 = new Player("ALex","Albon","F1 Driver",32);Player p1 = new Player("Akshay","patidaar","cricket player",22);
		Player p2 = new Player("Sachin","Tendulkar","cricket player",222);
		Player p3 = new Player("Aashish","Sehwag","cricket player",98);
		Player p4 = new Player("Jhon","Doe","cricket player",169);
